<x-admin.layout>
    ...
    <div class="page-btn">
    <a href="{{route('products.create',$restaurant)}}" class="btn btn-added">
    ...
    <tbody>
        ...
        <tr>
            ...
            <a href="javascript:void(0);" class="product-img">
                <img src="{{ $product->getFirstMediaUrl('product-image') ?: asset('admin/assets/img/product/noimage.png') }}" alt="product">
            </a>
            ...
            <td>
            <a class="me-3" href="{{route('products.edit', [$restaurant, $product])}}">
            <img src="{{asset("admin/assets/img/icons/edit.svg")}}" alt="img">
            </a>
            <form action="{{route('products.destroy', [$restaurant, $product])}}" method="POST" style="display: inline">
                @csrf
                @method('DELETE')
